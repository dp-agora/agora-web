...
import { getInsightArticlePaths } from "@/views/insights/insight-article-metadata";
...
export async function InsightArticleView({ locale, slug }: Props) {
    if (!slug) notFound();
    ...
    const { enSlug, esSlug } = getInsightArticlePaths(insight);
                            ...
                            <div className={insightArticleInner}>
                                ...
                                <div className="flex flex-wrap items-center gap-4 mt-4">
                                    <span className="text-sm text-slate-600">
                                        ...
                                        {insight.authorUrl ? (
                                            insight.authorUrl.startsWith("http://") ||
                                            insight.authorUrl.startsWith("https://") ? (
                                                <a
