...
export default function ComplianceSanctionsPage() {
    const t = useTranslations("ComplianceSanctions");
    const { openBooking } = useBooking();

    const coreServices = [
        { id: "sanctions-structuring", icon: Shield },
        { id: "ofac-licensing", icon: FileCheck },
        { id: "aml-abac", icon: Scale },
        { id: "banking-support", icon: Building2 }
    ];

    const valueFramework = [
        { id: "technical-rigor", number: "01" },
        { id: "deal-enablement", number: "02" },
        { id: "regulator-credibility", number: "03" },
        { id: "practice-integration", number: "04" }
    ];
    ...
    const jurisdictions = [
        ...
        { id: "us-ofac", icon: Shield },
        { id: "eu-uk", icon: Globe },
        { id: "cross-border", icon: CheckCircle }
    ];
    ...
    const relatedPractices = [
        ...
        { key: "environmental", path: "/practices/environmental" }
    ];
            ...
            <div className="flex min-h-screen flex-col">
                ...
                <main className="flex-1">
                    ...
                    <PageHeader
                        ...
                        imageSrc="/assets/practices/international-sanctions-compliance.jpeg"
                        imageAlt="Ágora Compliance & International Sanctions legal practice"
                        imageOpacity={0.7}
                                    ...
                                    <div className="bg-white p-8 border-l-4 border-primary/30">
                                        ...
                                        <ul className="space-y-3">
                                            <li className="flex items-start gap-3 text-slate-600">
                                                ...
                                                <span>{t("approach.situations.item1")}</span>
                                            </li>
                                            <li className="flex items-start gap-3 text-slate-600">
                                                <AlertTriangle className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
                                                <span>{t("approach.situations.item2")}</span>
                                            </li>
                                            <li className="flex items-start gap-3 text-slate-600">
                                                <AlertTriangle className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
                                                <span>{t("approach.situations.item3")}</span>
                                            </li>
                                            <li className="flex items-start gap-3 text-slate-600">
                                                <AlertTriangle className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
                                                <span>{t("approach.situations.item4")}</span>
                                            </li>
                                        </ul>
                                    </div>
