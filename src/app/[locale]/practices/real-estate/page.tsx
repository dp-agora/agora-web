...
export default function RealEstatePage() {
    ...
    const services = [
        { key: "acquisitions", icon: Building2 },
        { key: "development", icon: ClipboardCheck },
        { key: "structuring", icon: Landmark },
        { key: "infrastructure", icon: Hotel },
        { key: "foreign", icon: Globe },
        { key: "finance", icon: Banknote },
        { key: "leasing", icon: FileText },
        { key: "dueDiligence", icon: Search }
    ];

    const definitions = ["planning", "development", "crossBorder"];
    const valuePillars = ["integrated", "developer", "crossBorder", "institutional"];
    const matters = ["resort", "industrial", "hotel", "family", "urban"];
    const clientTypes = ["developers", "institutional", "family", "operators", "infrastructure"];
    ...
    const faqs = ["types", "foreign", "dueDiligence", "development", "integration", "infrastructure"];
