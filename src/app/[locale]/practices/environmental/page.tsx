...
export default function EnvironmentalPage() {
    ...
    const services = [
        { key: "permitting", icon: FileCheck },
        { key: "mining", icon: Mountain },
        { key: "hydrocarbons", icon: Fuel },
        { key: "infrastructure", icon: Building2 },
        { key: "crossBorder", icon: Globe },
        { key: "dueDiligence", icon: ClipboardCheck },
        { key: "maintenance", icon: RefreshCw },
        { key: "development", icon: Briefcase }
    ];

    const definitions = ["permitting", "sectoral", "crossBorder"];
    const valuePillars = ["integrated", "velocity", "intelligence", "bankability"];
    const matters = ["miningConsortium", "renewableEnergy", "industrialAcquisition", "hydrocarbonOperator", "transportCorridor"];
    const clientTypes = ["mining", "energy", "infrastructure", "investors", "industrial"];
    const relatedPractices = [
        { key: "corporate", path: "/practices/corporate-ma" },
        { key: "banking", path: "/practices/banking-finance" },
        { key: "realEstate", path: "/practices/real-estate" }
    ];
    ...
    return (
        <>
            ...
            <PageHeader
                ...
                description={t("intro.lead")}
                imageSrc="/assets/practices/enviromental-natural-resources.jpeg"
                imageAlt="Ágora Environmental & Natural Resources legal practice"
                imageOpacity={0.7}
