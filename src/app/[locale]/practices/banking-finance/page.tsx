...
export default function BankingFinancePage() {
    ...
    const teamMembers = [
        { slug: "alvaro-posada", key: "alvaro" },
        { slug: "marco-gomez", key: "marco" },
        { slug: "raul-sancristobal", key: "raul" },
        { slug: "dayana-veliz", key: "dayana" }
    ];
                                ...
                                {teamMembers.map((member, index) => (
                                    ...
                                    >
                                        <Link
                                            ...
                                            className="block p-6 bg-slate-50 hover:bg-primary group transition-all duration-500 border border-slate-100"
                                        >
                        ...
                        <div className="container mx-auto px-6 lg:px-12">
                            <div className="max-w-3xl mx-auto text-center space-y-8">
                                ...
                                >
                                    <Link
                                        href="/contact"
                                        className="inline-flex items-center gap-3 bg-white text-primary px-8 py-4 font-bold text-sm uppercase tracking-wider hover:bg-slate-100 transition-colors"
                                    >
                                        {t("cta.button")}
